...
export const metadata: Metadata = {
  ...
  description:
    "How E-Mobilite Limited collects, uses, retains, and protects your personal data when you use e-mobilite.ng and its services.",
};
      ...
      <section className="mx-auto max-w-3xl px-6 py-14 sm:py-16">
        ...
        <ul className="list-disc pl-6 space-y-2 text-text-secondary mb-4">
          ...
          <li>
            ...
            E-Mobilite Limited, 1610 Adeola Hopewell Street, Victoria Island, Lagos, Nigeria.
          </li>
          <li><strong>Personal Data</strong> is any information that relates to an identified or identifiable individual.</li>
          <li><strong>Service</strong> refers to the Website.</li>
          <li><strong>Website</strong> refers to E-Mobilite, accessible from e-mobilite.ng</li>
        </ul>
        ...
        <ul className="list-disc pl-6 space-y-2 text-text-secondary mb-4">
          ...
          <li>Provide news, programme updates and information about our fleet and network.</li>
          <li>Manage Your requests, including lease, hire-purchase, and partnership enquiries.</li>
        ...
        <P>
          ...
          <a href="mailto:info@e-mobilite.ng" className="text-brand">
            info@e-mobilite.ng
          </a>
        </P>
      </section>
