...
export const metadata: Metadata = {
  ...
  description:
    "The terms governing use of the E-Mobilite website, including acknowledgment, liability limitations, and the governing law of Nigeria.",
};
    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-6 py-14 sm:py-16">
        ...
        <P>
          ...
          &ldquo;Our&rdquo; refers to E-Mobilite Limited, 1610 Adeola
        ...
        <P>
          Nothing on this Service constitutes a binding offer of finance,
          lease, or hire-purchase terms. All vehicle financing, leasing, and
          hire-purchase arrangements are subject to separate contractual
          agreements and eligibility assessment.
        </P>
