    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-6 py-14 sm:py-16">
        ...
        <P>
          ...
          to E-Mobilite Limited, 1610 Adeola Hopewell Street, Victoria
          Island, Lagos, Nigeria. <strong>Website</strong> refers to
          E-Mobilite, accessible from e-mobilite.ng
        </P>
